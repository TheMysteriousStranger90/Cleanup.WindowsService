...
{
    private readonly CleanupOrchestrator _cleanupOrchestrator;
    private readonly ILogger<WindowsBackgroundService> _logger;
    
    public WindowsBackgroundService(CleanupOrchestrator cleanupOrchestrator, ILogger<WindowsBackgroundService> logger)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                await _cleanupOrchestrator.RunCleanupTasksAsync(stoppingToken);
